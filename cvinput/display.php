...
if (isset($_GET['id'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        <body>
            ...
            <p><strong>LinkedIn:</strong> <?php echo htmlspecialchars($row['linkedin']); ?></p>
            <p><strong>GitHub:</strong> <?php echo htmlspecialchars($row['github']); ?></p>
            <p><strong>Objective:</strong> <?php echo nl2br(htmlspecialchars($row['objective'])); ?></p>
            <p><strong>Institute Name:</strong> <?php echo htmlspecialchars($row['institute_name1']); ?></p>
            <p><strong>Average GPA / Percentage:</strong> <?php echo htmlspecialchars($row['average_gpa1']); ?></p>
            <p><strong>University Name:</strong> <?php echo htmlspecialchars($row['university_name']); ?></p>
            <p><strong>Institute Name (if any):</strong> <?php echo htmlspecialchars($row['institute_name2']); ?></p>
            <p><strong>Skills & Abilities:</strong> <?php echo nl2br(htmlspecialchars($row['skills_abilities'])); ?></p>
            <p><strong>Projects:</strong> <?php echo nl2br(htmlspecialchars($row['projects'])); ?></p>
            <p><strong>Extracurricular Activities:</strong> <?php echo nl2br(htmlspecialchars($row['extracurricular'])); ?></p>
            <p><strong>Training:</strong> <?php echo nl2br(htmlspecialchars($row['training'])); ?></p>
            <p><strong>Hobbies & Interests:</strong> <?php echo nl2br(htmlspecialchars($row['hobbies_interests'])); ?></p>
